...
<div class="exercises-promo-block">
	...
	<div class="row exercises-promo-block_row">
		<div class="col-md-6 exercises-promo-block__left-side">
			...
			<a href="/trainings/exercises/"><div class="exercises-promo-block__left-side__button">
		...
		<div class="col-md-6 exercises-promo-block__right-side">
			<div class="img-block">
				<? foreach ($sections as $id => $section) : ?>
					<div class="img-block_img-link" id="<?= $section['ID'] ?>">
				...
				<div class="exercises-promo-block__right-side__tabs">
					<ul>
						<? foreach ($sections as $id => $section) : ?>
							<a class="exercises-promo-block__right-side__tab active" id="backbone" href="/trainings/exercises/<?= $section['CODE'] ?>"><li><?= $section['NAME'] ?></li></a>
						<? endforeach; ?>
					</ul>
				</div>
			</div>
