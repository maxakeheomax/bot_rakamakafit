...
<div class="tapes promo-train-block__slider-item" >
    <!-- <div class="promo-train-block__slider-item__slider-content">
        <div class="promo-train-block__slider-item__slider-content-tabs">
            <p class="promo-train-block__slider-item__slider-content__promo-title active">Латексные фитнес резинки</p> 
            <p class="promo-train-block__slider-item__slider-content__promo-title">Тканевые резинки</p> 
        </div>
        <p class="promo-train-block__slider-item__slider-content__slogan">Прочные и широкие фитнес ленты</p>
        <p class="promo-train-block__slider-item__slider-content__dicription">легко брать с собой, комбинировать друг с другом и прорабатывать все группы мышц. С резинками Rakamakafit из натурального латекса заниматься дома или на свежем воздухе можно в любую минуту.</p>
        <div class="promo-train-block__slider__content_bottom">
            ...
            <div class="promo-train-block__slider-item-more">
                <a href="#">
                    ...
                    <span class="promo-train-block__slider-item-more__text"><img src="assets/ytb-color.svg" alt="">Смотреть видео тренировок</span></a>
                </div>
            </div>
        </div>
    </div> -->
