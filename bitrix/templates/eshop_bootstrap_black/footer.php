    ...
    <div class="footer__footer-wrapper">
        ...
        <div class="footer footer-desktop footer__footer-credits">
            <div class="footer__footer-credits__icons">
                <a target="_blank" href="https://vk.com/rakamakafit"><img
                        src="<?= SITE_TEMPLATE_PATH ?>/assets/footer-inst.svg" alt=""></a>
                <a target="_blank"
                    href="https://www.youtube.com/channel/UCVZQTeZTLrz166tbN0bEGkg?sub_confirmation=1"><img
                        src="<?= SITE_TEMPLATE_PATH ?>/assets/footer-ytb.svg" alt=""></a>
                <a target="_blank" href="https://www.instagram.com/rakamaka.fit/"><img
                        src="<?= SITE_TEMPLATE_PATH ?>/assets/footer-vk.svg" alt=""></a>
            </div>
...
<footer class="footer footer-tablet">
    ...
    <div class="footer__footer-wrapper">
        ...
        <div class="footer__nav">
            ...
            <div class="footer__footer-credits__icons">
                <a href="https://vk.com/rakamakafit"><img src="<?= SITE_TEMPLATE_PATH ?>/assets/vk-color-tablet.svg"
                        alt=""></a>
                <a href="https://www.youtube.com/channel/UCVZQTeZTLrz166tbN0bEGkg?sub_confirmation=1"><img
                        src="<?= SITE_TEMPLATE_PATH ?>/assets/ytb-color-tablet.svg" alt=""></a>
                <a href="https://www.instagram.com/rakamaka.fit/"><img
                        src="<?= SITE_TEMPLATE_PATH ?>/assets/inst-color-tablet.svg" alt=""></a>
            </div>
        </div>
    ...
    <div class="auth-block">
        ...
        <div class="LogIn-block">
            ...
            <form class="auth-block-form" action="/auth.php">
                ...
                <div class="auth-reg-wrapper login-block">
                    <input name="mail" id="email" class="auth-reg__form__input" type="email" required
                        pattern="\S+@[a-z]+.[a-z]+" placeholder='Email*'>
                    <label></label>
                    <input name="password" id="pass" class="auth-reg__form__input pass" type="password"
                        placeholder='Пароль*'>
                    <label for="pass"></label>
                    <p id="login_error_text_section" style="color: red; display:none;">Не правильный логин или пароль
                    </p>

                    <div class="promo-form-block__form__input-checkbox-wrapper">
                        <input class="promo-form-block__form__checbox" type="checkbox" name="remember"
                            id="auth-checkbox">
            ...
            <div class="auth-social-block">
                <a href="#">
                    <div class="auth-social-block-item" style="background:url(assets/vk-reg-form.svg)no-repeat center;">
                    </div>
                </a>
                <a href="#">
                    <div class="auth-social-block-item" style="background:url(assets/fb-reg-form.svg)no-repeat center;">
                    </div>
                </a>
                <a href="#">
                    <div class="auth-social-block-item"
                        style="background:url(assets/ggl-plus-reg-form.svg)no-repeat center;"></div>
                </a>
            </div>
        </div>
        <!--end of LogIn-block -->
        ...
        <div class="registr-block hidden-block">
            ...
            <form id="register_form" class="auth-block-form" action="/register.php">
                <div class="auth-reg-wrapper">
                    ...
                    <input name="name" id="name" class="auth-reg__form__input registration_field" type="text"
                        pattern="[A-Za-zА-Яа-яЁё]+" placeholder='Имя'>
                    <label for="name"></label>

                    <input name="mail" id="email" class="auth-reg__form__input registration_field" type="email" required
                        pattern="\S+@[a-z]+.[a-z]+" placeholder='Email*'>
                    <label></label>

                    <input name="password" id="pass" class="auth-reg__form__input registration_field pass"
                        type="password" placeholder='Пароль*'>
                    <label for="pass"></label>


                    <input name="repeat-password" id="repeat-pass" class="auth-reg__form__input registration_field pass"
                    ...
                    <div class="promo-form-block__form__input-checkbox-wrapper">
                        ...
                        <p class="promo-form-block__form__checbox-desc">Я согласен с <a href="#">обработкой данных</a>
                        </p>
                    </div>
        ...
        <div class="greetings-block hidden-block">
            ...
            <span class="hello-icon"
                style="background: url('assets/waving-hand-sign.png') no-repeat; background-size:contain; "></span>
        ...
        <div class="accordion" id="FAQaccordion">
                ...
                <div id="collapseOne" class="collapse" aria-labelledby="headingOne" data-parent="#FAQaccordion">
                    <div class="card-body">
                        <p>В тренировочном плане с резинками используются только фитнес-резинки.
                            В остальных тренировочных планах базовым оборудованием для выполнения тренировок являются
                            фитнес-ленты #RAKAMAKAFIT, также в программе будут упражнения с эспандерами, грифом и
                            фитболом. Мы подобрали упражнения на все группы мышц.</p>
                    </div>
                </div>
            </div>
            <div class="card">
                ...
                <div id="collapseTwo" class="collapse" aria-labelledby="headingTwo" data-parent="#FAQaccordion">
                    <div class="card-body">
                        <p>Доступ в систему предоставляется на 5 недель. Отсчёт периода происходит С ПЕРВОГО ЗАХОДА на
                            сайт ПОД СВОЕЙ УЧЁТНОЙ ЗАПИСЬЮ.
                            Ограничение периода мотивирует клиентов не пропускать тренировки и достигать максимальных
                            результатов!
                            Система подразумевает не только доступ к системе, но и возможность консультаций с нашими
                            кураторами в чате на сайте программы тренировок.</p>
                    </div>
                </div>
            </div>
            <div class="card">
                ...
                <div id="collapseThree" class="collapse" aria-labelledby="headingThree" data-parent="#FAQaccordion">
                    <div class="card-body">
                        <p>Да! Доступно пять вариантов рациона: стандартный, диабетик, вегетарианец, веган и даже без
                            лактозы. </p>
                    </div>
                </div>
            </div>
                ...
                <div id="collapseFour" class="collapse" aria-labelledby="headingFour" data-parent="#FAQaccordion">
                    <div class="card-body">
                        <p>Мы предлагаем специальные программы для клиентов с проблемами коленных суставов и диастазом.
                            Но мы настоятельно рекомендуем вам проконсультироваться с врачом перед покупкой курса, так
                            как все проблемы со здоровьем очень индивидуальны, и мы не несем ответственности за ваше
                            состояние после тренировок с имеющимися у вас проблемами со здоровьем.</p>
                    </div>
                </div>
            </div>
            <div class="card">
                ...
                <div id="collapseFive" class="collapse" aria-labelledby="headingFive" data-parent="#FAQaccordion">
                    <div class="card-body">
                        <p>Программа курса рассчитана на 3 тренировки в неделю, длительность курса 5 недель. Перерыв
                            между тренировками – 1-2 дня для восстановления, дни для тренировок вы можете выбирать
                            самостоятельно.</p>
                    </div>
                </div>
            </div>
                ...
                <div id="collapseSix" class="collapse" aria-labelledby="headingSix" data-parent="#FAQaccordion">
                    <div class="card-body">
                        <p>Да, мы предлагаем различные варианты программы для набора мышечной массы и для снижения веса.
                            Для наилучших результатов наращивания мышечной массы мы рекомендуем использовать в
                            упражнениях ленты и эспандеры с бОльшим сопротивлением .</p>
                    </div>
                </div>
            </div>
            <div class="card">
                ...
                <div id="collapseSeven" class="collapse" aria-labelledby="headingSeven" data-parent="#FAQaccordion">
                    <div class="card-body">
                        <p>Для продолжения тренировок по программе по истечении 5 недель с момента активации курса,
                            потребуется повторная покупка курса, курс снова будет активирован на ближайшие 5 недель.</p>
                    </div>
                </div>
            </div>
            <div class="card">
            ...
            <div class="card">
                ...
                <div id="collapseNine" class="collapse" aria-labelledby="headingNine" data-parent="#FAQaccordion">
                    <div class="card-body">
                        <p>
                            Вы можете совмещать тренировки и дома и в любом удобном для вас месте. Имейте ввиду, что
                            нагрузка от занятий на тренажерах иная. Наша программа подготовленна специально для тех, кто
                            тренируется дома.
...
$(document).ready(function() {
    ...
    $(".promo-form-block__form__submit").click(function() {
        ...
        $.post("/include/ajax/buyOneClick.php", {
            ...
            name: $(".fake-detection-form-block__form__input-wrapper label[name='name'] input")
                .val(),
            email: $(".fake-detection-form-block__form__input-wrapper label[name='mail'] input")
                .val(),
            phone: $(
                    ".fake-detection-form-block__form__input-wrapper label[name='phone'] input")
                .val(),
        }, function(data) {
            $('body').css('overflow-y', 'inherit');
            $('.page_content').css('filter', 'none')
    ...
    <div class="wrapper-block">
        ...
        <div class="buy_in_click_popUp__left-side">
            <div class="pop-products-block__item">
                ...
                <div class="pop-products-block__item__title"><span class="title-span">Программа тренировок Rakamakafit
                        Online</span></div>
            ...
            <div class="fake-detection-form">
                ...
                <form action="#">
                    <div class="fake-detection-form-block__form__input-wrapper">
                        <label name="mail">
                            <input class="promo-form-block__form__input" type="email" pattern="\S+@[a-z]+.[a-z]+"
                                placeholder="Email">
                        </label>
                        <label name="phone">
                            <input class="promo-form-block__form__input" type="text" required="" mask=""
                                pattern="[0-9]{11}" placeholder="Телефон">
                        </label>
                        <label name="name">
                            <input class="promo-form-block__form__input" type="text" required="" pattern="\W+\S+"
                                placeholder="Имя">
                        </label>
